...
$description = !empty(get_field('description_partners')) ? "<div class='technology-partners-ps__description'>" . get_field('description_partners') . "</div>" : "";
...
<section class="technology-partners-ps" <?php echo $anchor; ?>>
  <div class="container">
    ...
    if (!empty($partners) && count($partners) > 0) {      ?>
      <div class="technology-partners-ps__items">
        <?php foreach ($partners as $key => $partner) { ?>
          <div class="technology-partners-ps__items_item item">
