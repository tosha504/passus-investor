...
!(function (t, e) {
  ...
  var g = function (t) {
    ...
    m = function t() {
      for (
        var i = !1, n = arguments.length, o = new Array(n), s = 0;
        s < n;
        s++
      )
        o[s] = arguments[s];
    ...
    k = (function () {
      function t() {
        ...
        for (var n = 0, o = ["on", "once"]; n < o.length; n++)
          for (
            var s = o[n], a = 0, r = Object.entries(this.options[s] || {});
            a < r.length;
            a++
          ) {
            var l = r[a];
          ...
          },
          {
            ...
            value: function (t) {
              ...
              try {
                for (s.s(); !(o = s.n()).done; ) {
                  var a = o.value;
                  if (a && !1 === a.call.apply(a, [this, this].concat(i)))
                    return !1;
                }
              } catch (t) {
                s.e(t);
    ...
    C = (function (t) {
      ...
      function n(t) {
        ...
        if (
          ...
          o.$content ||
            (o.$content = o.$viewport.querySelector(".panzoom__content")),
          !o.$content)
        )
          throw new Error("Content not found");
        if (
          (!1 === o.option("textSelection") &&
            o.$viewport.classList.add("not-selectable"),
          o.resetValues(),
      ...
      return (
        o(n, [
          ...
          },
          {
            key: "resetValues",
            value: function () {
              (this.viewportDim = { top: 0, left: 0, width: 0, height: 0 }),
                (this.contentDim = { width: 0, height: 0 }),
          ...
          },
          {
            ...
            value: function () {
              ...
              (s -= parseFloat(r.paddingLeft) + parseFloat(r.paddingRight)),
                ...
                (this.viewportDim = { top: n, left: o, width: s, height: a }),
                (this.contentDim = {
                  width: this.option(
                    "width",
                    ((t = this.$content),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                n.width > o.width
                  ? (e.from = y(e.to + o.width - s))
                  : (e.from = y(-1 * e.to)),
                (i.to = y(0.5 * (a - n.height))),
                n.height > o.height
                  ? (i.from = y(i.to + o.height - a))
                  : (i.from = y(-1 * i.to)),
                (this.boundX = e),
                (this.boundY = i),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              Math.abs(g) < 1 && (g = 0),
                ...
                (n = this.current.x - g),
                (s = this.current.y - m),
                this.panTo({ x: n, y: s, scale: t, friction: r });
            },
          },
          {
            key: "panTo",
            ...
            value: function () {
              ...
              if (!this.pendingAnimateUpdate) {
                if (
                  ...
                  return (
                    this.transform(),
                    void (this.pendingAnimateUpdate = requestAnimationFrame(
                      function () {
                ...
                (this.current.x = y(
                  this.current.x + this.velocity.x / (1 / this.friction - 1)
                )),
                  (this.current.y = y(
                    this.current.y + this.velocity.y / (1 / this.friction - 1)
                  )),
                  ...
                  Math.abs(this.current.scale - 1) < 0.01 &&
          ...
          },
          {
            ...
            value: function () {
              if ("decel" === this.state) {
                ...
                if (
                  (a &&
                    ((t = this.current.x < a.from),
                    (e = this.current.x > a.to)),
                  r &&
                    ((i = this.current.y < r.from),
                    (n = this.current.y > r.to)),
                  t || e)
                ) {
                  var l = (t ? a.from : a.to) - this.current.x,
                    ...
                    h =
                      this.current.x +
                      (this.velocity.x + c) / (1 / this.friction - 1);
                  (t && h < a.from) ||
                    (e && h > a.to) ||
                    (c = l * s - this.velocity.x),
                    (o.x = c);
                }
                if (i || n) {
                  var d = (i ? r.from : r.to) - this.current.y,
                    ...
                    f =
                      this.current.y +
                      (this.velocity.y + u) / (1 / this.friction - 1);
                  (i && f < r.from) ||
                    (n && f > r.to) ||
                    (u = d * s - this.velocity.y),
                    (o.y = u);
                }
            ...
            value: function () {
              "dragging" === this.state &&
                (this.velocity = {
                  x:
                    (1 / this.friction - 1) *
                    (this.drag.endPosition.x - this.current.x),
                  y:
                    (1 / this.friction - 1) *
                    (this.drag.endPosition.y - this.current.y),
                  scale:
                    (1 / this.friction - 1) *
                    (this.drag.endPosition.scale - this.current.scale),
                });
            },
          },
          {
            ...
            value: function () {
              ...
              (this.resizeObserver =
                ...
                new b(function (e) {
                  t.pendingResizeUpdate =
                    ...
                    setTimeout(function () {
                      ...
                      !i &&
                        t.$viewport &&
                        (i = t.$viewport.getBoundingClientRect()),
                        i &&
                ...
                e.addEventListener("click", this.onClick, { passive: !1 }),
          ...
          },
          {
            ...
            value: function () {
              ...
              window.PointerEvent
                ...
                t.removeEventListener("click", this.onClick, { passive: !1 }),
          ...
          },
          {
            key: "getDistance",
            value: function (t, e) {
              if (!(t = (t = t || u(this.pointers)).slice()) || t.length < 2)
                return 0;
                ...
                if (this.option("panOnlyZoomed") && this.velocity.scale)
                  ...
                  if (
                    ...
                    this.pointers.length > 1 ||
                      (this.pointers.length && this.lockAxis))
                  )
                    t.preventDefault();
                    ...
                    if (
                      ...
                      var n =
                        ...
                        (this.events.doubleClick &&
                          this.events.doubleClick.length) ||
                        this.option.click ||
                      ...
                      if (
                        ...
                        if (
                          ...
                          (this.drag.endPosition.x =
                            this.drag.startPosition.x + c),
                          (this.drag.endPosition.y =
                            this.drag.startPosition.y + h),
                          this.pointers.length > 1)
                        ) {
                          (this.drag.middlePoint = e),
                            (l =
                              (this.drag.startPosition.scale *
                                this.getDistance()) /
                          ...
                          var d = this.$content.width,
                            ...
                            g =
                              (d * l - f) *
                              ((this.drag.startPoint.clientX -
                                this.drag.startPosition.left) /
                                f -
                                0.5),
                            m =
                              (p - v) *
                              ((this.drag.startPoint.clientY -
                                this.drag.startPosition.top) /
                                v -
                                0.5);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (this.pointers.length > 0)
                return t.preventDefault(), void this.resetDragState();
              if ("pointerdown" === this.state || "dragging" === this.state) {
                ...
                if (
                  ...
                  (o.distance = Math.sqrt(
                    Math.pow(o.distanceX, 2) + Math.pow(o.distanceY, 2)
                  )),
                  (this.state = "decel"),
                  ...
                  if (this.current.scale < s)
                    this.zoomTo(s, { friction: 0.64 });
                  else {
                    var a = this.option("maxScale");
                    if (this.current.scale - a > 0.01) {
                      var r = { friction: 0.64 };
                      o.middlePoint &&
                        ((r.x = o.middlePoint.clientX - n),
                        (r.y = o.middlePoint.clientY - i)),
                        this.zoomTo(a, r);
                    }
                  }
                }
          ...
          },
          {
            ...
            value: function () {
              ...
              if (
                (o &&
                  ((t = this.drag.endPosition.x < o.from),
                  (e = this.drag.endPosition.x > o.to)),
                s &&
                  ((i = this.drag.endPosition.y < s.from),
                  (n = this.drag.endPosition.y > s.to)),
                t || e)
              ) {
                var a = t ? o.from : o.to,
          ...
          },
          {
            ...
            value: function (t) {
              ...
              (e = (e * (100 + i * this.option("wheelFactor"))) / 100),
                t.preventDefault();
            ...
            value: function (t) {
              ...
              if (!t.defaultPrevented) {
                ...
                if (
                  ...
                  (Math.abs(
                    this.drag.endPosition.top - this.drag.startPosition.top
                  ) > 1 ||
                    Math.abs(
                      this.drag.endPosition.left - this.drag.startPosition.left
                    ) > 1)
                )
                  return t.stopPropagation(), void t.stopImmediatePropagation();
        ...
        o(t, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              null !== i &&
                (this.nav.slideTo(i, !0 === t ? { friction: 0 } : {}),
  ...
  L.defaults = { friction: 0.92 };
  var T = { Navigation: S, Dots: E, Sync: L },
    M = {
      slides: [],
      preload: 0,
      slidesPerPage: "auto",
        ...
        o(n, [
          {
            ...
            value: function () {
              ...
              ((this.$viewport =
                ...
                this.$element.querySelector("." + i.viewport)),
              this.$viewport) ||
                ((this.$viewport = document.createElement("div")),
                this.$viewport.classList.add(i.viewport),
                (t = this.$viewport).append.apply(
                  t,
                  u(this.$element.childNodes)
                ),
                this.$element.appendChild(this.$viewport));
              ((this.$track =
                this.option("track") ||
                this.$element.querySelector("." + i.track)),
              this.$track) ||
          ...
          },
          {
            ...
            value: function () {
              var t = this.page;
              null === t && (t = this.page = this.option("initialPage")),
                this.updateMetrics();
              var e = this.pages;
              e[t] || (t = e.length ? e[e.length - 1].index : 0),
                this.slideTo(t, { friction: 0 });
            },
          },
          {
            key: "updateBounds",
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                var i = d(
                  this.getPageFromPosition(-1 * this.Panzoom.pan.x),
                  2
                )[1];
                this.setPage(i);
          ...
          },
          {
            ...
            value: function () {
              if (
                ...
                return (
                  t.current.x <
                    -1 * (t.contentDim.width - t.viewportDim.width) &&
                    ((t.current.x += t.contentDim.width),
                    t.drag.firstPosition &&
                      (t.drag.firstPosition.x += t.contentDim.width),
          ...
          },
          {
            ...
            value: function () {
              ...
              this.slides.forEach(function (t, i) {
                ...
                (this.Panzoom.viewportDim.height =
                  this.Panzoom.$content.clientHeight),
            ...
            value: function () {
              ...
              if (n) {
                ...
                Math.abs(i - 1) > 0.1 &&
                  ...
                  (n.style.height = s),
                  (n.style.transform = a),
                  t.Carousel && t.Carousel.updateMetrics();
              }
            },
          },
          {
    ...
    z = (function () {
      function t(e) {
        i(this, t),
          ...
          (this.state = "init");
        for (
          var n = 0, o = ["onReady", "onClosing", "onKeydown"];
          n < o.length;
          n++
        ) {
          var s = o[n];
          ...
          },
          {
            ...
            value: function () {
              ...
              if ("init" === this.state) {
                ...
                if (e.length < this.fancybox.option("Thumbs.minSlideCount"))
                  return !1;
                ...
                i.classList.add("fancybox__thumbs"),
                  ...
                  (this.Carousel = new A(
                    ...
                    m(
                      ...
                      { Sync: { with: this.fancybox.Carousel }, slides: e }
                    )
                  )),
  ...
  z.defaults = { autoStart: !0, minSlideCount: 3, key: "t" };
  var _ = function (t) {
                    ...
                    this.fancybox.setContent(
                      ...
                      this.fancybox
                        ...
                        .replace(
                          "{{format}}",
                          i.format ||
                            (i.html5video && i.html5video.format) ||
                            ""
                        )
                  ...
                  m(!0, this.fancybox.option("Image.Panzoom"), {
                    ...
                    on: {
                      afterAnimate: function (i) {
                        "zoomIn" === t.state &&
                          (i.attachEvents(), e.fancybox.done(t)),
                          e.handleCursor(t);
                      },
                      updateMetrics: function () {
                        e.handleCursor(t);
            ...
            value: function () {
              ...
              if (this.fancybox.option("Image.ignoreCoveredThumbnail")) {
                var a = document.elementFromPoint(s.left + 1, s.top + 1) === o,
                  r =
                    document.elementFromPoint(s.right - 1, s.bottom - 1) === o;
                i = a && r;
              } else
                i =
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return (
                ...
                { top: l, left: c, scale: e.width / a, opacity: h }
              );
            },
          },
          {
            ...
            value: function (t) {
              ...
              e && "toggleZoom" === i
                ? n[
                    e &&
                    1 === e.current.scale &&
                    e.option("maxScale") - e.current.scale > 0.01
                      ? "add"
                      : "remove"
              ...
              if (
                !(
                  ...
                  ("IMG" != e.target.tagName &&
                    !e.target.classList.contains("fancybox__content"))
                )
              )
                switch (
                  (e.preventDefault(),
          ...
          r = function (t, e) {
            ...
            return (
              t.forEach(function (t) {
                ...
                if (e) {
                  var i = e.dataset || {};
                  (t.src = i.src || e.getAttribute("href") || t.src),
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                ...
                n &&
                  (i = this.$container.classList).add.apply(i, u(n.split(" ")));
                return (
            ...
            },
            {
              ...
              value: function (t) {
                ...
                (Math.abs(e) >= 150 ||
                  (Math.abs(e) >= 35 && t.drag.elapsedTime < 350)) &&
                  ...
                  var e = Math.abs(t.current.y),
                    i =
                      e < 1
                        ...
                        : Math.max(
                            0,
                            Math.min(1, 1 - (e / t.$content.clientHeight) * 1.5)
                          );
              ...
              value: function (t) {
                ...
                try {
                  for (s.s(); !(n = s.n()).done; ) {
                    ...
                    if (
                      !a.classList ||
                      !a.classList.contains("fancybox__slide")
                    ) {
                      var r = a.closest(".fancybox__slide");
                      r
                        ? r === i &&
                          o[a.hasAttribute("autofocus") ? "unshift" : "push"](a)
                        : o.push(a);
                    }
                  }
                } catch (t) {
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  ...
                  "loading" !== t.state &&
                    (this.trigger("load", t), this.revealContent(t)),
                  i
                );
              },
            },
              ...
              value: function (t) {
                ...
                if (D) {
                  if (!n.openers.size) {
                    ...
                    for (
                      var i = 0, o = Object.entries(n.Plugins || {});
                      i < o.length;
                      i++
                    ) {
                      var s = d(o[i], 2);
                      ...
                      var a = s[1];
                      (a.Fancybox = this),
                        "function" == typeof a.create && a.create();
                    }
                  }
                  n.openers.set(t, e);
                }
